...
src/%.o: ../src/%.asm
	@echo 'Building file: $<'
	$(file > $@.in,-O0 -ffunction-sections -fdata-sections -Wstack-usage=256 -g2 -mcpu=s2 -x assembler-with-cpp -Wa,--gdwarf2 -I"E:/AIoT/Code/Rogger/Test_new/DGC_A230_6_Rev_1_0_Software/src" -Wa,-adlhn="$(basename $(notdir $<)).lst" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c "$<" -o "$@")
	@rl78-elf-gcc @"$@.in"
